...
function preload() {
    ...
    audioGameOver = loadSound('audio/gameOver.mp3');
    ...
    audioMissileMovement = loadSound('audio/missileMovement.wav');
    ...
    audioRoundComplete = loadSound('audio/roundComplete.mp3');
